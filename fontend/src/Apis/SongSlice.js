...
export const getAllSongs = createAsyncThunk("getSongs",async function getSong() {
    const URL = base + "/song";
    // console.log(URL);
    try {
...
export const getSongById = createAsyncThunk("getSongById", async function getSongById(id) {
