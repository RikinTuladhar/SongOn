...
const CardLib = ({ id, name, songlist, img }) => {
  ...
  return (
    ...
    <Link key={id} to={`/library/${id}`}>
      <div className="w-52 flex flex-col gap-5 h-auto px-5 bg-[#1b1b1b4d]  py-2 rounded-md min-h-52 hover:bg-[#1b1b1bd3]  hover:ease-in">
        <div className="w-full h-[150px] mt-2 mb-2 ">
          <img
