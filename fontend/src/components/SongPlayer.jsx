    ...
    <div className="fixed border rounded-lg bottom-0  md:bottom-4 ">
      <footer class="bg-[#000000] rounded-lg shadow  ">
        ...
        <div class="w-full flex-wrap  flex gap-6 md:gap-1 mx-auto max-w-screen-xl md:p-5   md:justify-center  md:items-center ">
          ...
          <div className="flex gap-2  md:px-10 text-base text-white"><span>Song:</span><span>{name[currentIndex]}</span></div>
          ...
          <ul class="flex pb-5 flex-wrap gap-3 md:gap-10 justify-center items-center  font-thin text-xs md:text-lg  md:font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <li className=" order-2 md:order-1 ">
              <button className=" py-1 px-2 md:px-5 md:py-2 border rounded-2xl" onClick={previousSong}>Previous Song  </button>
            </li>
            <li className=" order-3  md:order-2 ">
              <button className=" py-1 px-2 md:px-5 md:py-2 border rounded-2xl" onClick={backward}>Backward</button>
            </li>
            <li className=" mx-5 md:px-0  my-0 mx-auto order-1 md:order-3">
            ...
            <button className="py-1 px-2 md:px-5 md:py-2 border rounded-2xl" onClick={forward}>Forward</button>
             
            </li>
           
            <li className="order-5 md:order-5">
            <button className="py-1 px-2 md:px-5 md:py-2 border rounded-2xl" onClick={nextSong}>Next Song</button>
            </li>
          </ul>
        </div>
      </footer>
