...
const LibraryLeft = () => {
  ...
  // Check if songArray and songClickedId are defined and valid
  const song = songArray && songArray[songClickedId];
  const artist = song && song.artist && song.artist[0];
