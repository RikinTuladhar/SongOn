    ...
    <div className="w-full p-10 ">
      <div className="w-full h-[30%] gap-10 flex justify-center flex-wrap">
        <div className="w-[20rem] h-[10rem] flex justify-center items-center rounded-2xl hover:scale-110 transition-all hover:bg-[#0f0f0ff2] bg-[#0f0f0f]">
          <h1 className="p-5 text-4xl font-bold text-transparent bg-gradient-to-b from-neutral-100 to-neutral-700 bg-clip-text">
        ...
        <div className=" p-5 w-[20rem] h-[10rem] flex justify-center items-center rounded-2xl hover:scale-110 transition-all hover:bg-[#0f0f0ff2] bg-[#0f0f0f]">
          <h1 className="text-4xl font-bold text-transparent bg-gradient-to-b from-neutral-100 to-neutral-700 bg-clip-text">
      ...
      <h1 className="p-5 mt-10 text-4xl font-bold text-transparent bg-gradient-to-b from-black to-neutral-500 bg-clip-text">
        Top Songs
      </h1>
      ...
      <div className="w-full my-5 h-[0.25rem] bg-black"></div>
      <h1 className="mt-10 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-black to-neutral-500 ">
        Top Listener
      </h1>
      <div className="mt-10 space-y-5 h-[50vh] overflow-y-auto">
        <div className="grid grid-cols-3 text-xl h-[full] flex-col w-full pl-10 gap-10">
          {Array.from({ length: 12 }).map((_, index) => (
            <div
              key={index}
              className="w-[] rounded-2xl px-16 py-5 h-[10rem] bg-green-300"
            >
              {index + 1} {/* Example song name */}
            </div>
          ))}
        </div>
      </div>
